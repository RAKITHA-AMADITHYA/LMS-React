              ...
              <Grid item xs={12} sm={12} md={12} lg={9}  >
                ...
                <Box padding={1}   >
                  <Grid item xs={12} sm={12} md={12} lg={12} margin={1}>
                    <Typography variant='h4' style={{ fontFamily: '"Mukta", sans-serif' }}>Security</Typography>
                  </Grid>
                  <Grid item lg={12} >
                    <Typography variant='subtitle1' fontFamily={'"Mukta", sans-serif'} margin={1} fontSize={18}>Change Your Password Today!</Typography>
                  </Grid>
